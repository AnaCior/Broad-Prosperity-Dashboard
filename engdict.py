...
Themes = {
    ...
    "Gross Domestic Product": """
        **Welcome to the Gross Domestic Product indicator**
        ...
        - Measuring unit: Euro per inhabitant (2015 prices)
    """,
    "Overweight": """
    ...
    "Net labor participation": """
        **Welcome to the Net Labor Participation indicator**
        ...
        - Measuring unit: Percentage of the population aged 15 to 74
    """,
    ...
    "Highly educated population": """
        **Welcome to the Highly Educated Population indicator**
        - This indicator is part of the Work and Leisure theme.
        - Measuring unit: Percentage of the population (15 to 74 years) that has completed higher education
    """,
    "Unemployment": """
    ...
    "Vacancy rate": """
        **Welcome to the Vacancy Rate indicator**
        ...
        - Measuring unit: Number of vacancies per 1,000 jobs
    """,
    ...
    "Phosphate excretion agriculture": """
        **Welcome to the Phosphate Emissions from Agriculture indicator**
        - This indicator is part of the Natural Capital theme.
        - Measuring unit: kg per ha of fertilized cultivated land
    """,
    "Green-blue space, excluding regular agriculture": """
        **Welcome to the Green-Blue Space (Excluding Regular Agriculture) indicator**
        - This indicator is part of the Natural Capital theme.
        - Measuring unit: 
    """,
    ...
    "Working hours per week": """
        **Welcome to the Weekly Working Hours indicator**
        ...
        - 2021 and 2022 figures are preliminary.
        - Measuring unit: Number of hours of actual hours worked per worker per week
    """,
    "Highly educated population": """
        **Welcome to the Highly Educated Population indicator**
        - This indicator is part of the Human Capital theme.
    ...
    """,
    "Living": """
        **Welcome to the Living theme**
        - In this theme, the following indicators are included: Satisfaction with living environment, 
        Satisfaction with housing, Distance to sports field, Distance to primary school, Distance to café
    """,
    "Society": """
    ...
    "Safety": """
        **Welcome to the Safety theme**
        - In this theme, the following indicators are included: Often feeling unsafe in the neighborhood, 
        Number of crimes encountered, Recorded crimes
    """,
    "Environment": """
